...
int main()
{
	vector<float> lista_nueva=fill(10000);
	double timeIni1, timeFin1,timeIni_par,timeFin_par;
    timeIni1 = omp_get_wtime();
    cout<<"-------------PROGRAMA EN FORMA SERIAL-------------"<<endl;
    //Count_sort_serial (lista_nueva, 1000000);
    //odd_sort_serial (lista_nueva, 10000 ) ;
    /*vector<int> nuevo1=Count_sort_serial (lista_nueva, 1000000);
    ...
    //odd_sort_parallel (lista_nueva, 10000 ) ;
    //Count_sort_parallel(lista_nueva, 1000000,10);
    /*vector<int> nuevo=Count_sort_parallel(lista_nueva, 1000000,10);
